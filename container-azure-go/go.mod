...
require (
	github.com/pulumi/pulumi-azure-native-sdk/containerinstance/v2 v2.0.0-alpha.4
	github.com/pulumi/pulumi-azure-native-sdk/containerregistry/v2 v2.0.0-alpha.4
