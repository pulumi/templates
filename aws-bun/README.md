# AWS Bun Pulumi Template

A minimal Pulumi template for provisioning AWS infrastructure using Bun. This template creates an Amazon S3 bucket and exports its name.
