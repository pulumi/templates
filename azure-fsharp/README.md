 # Azure Native F# Pulumi Template

 A minimal, end-to-end Pulumi template for F# that provisions a Resource Group and Storage Account in Microsoft Azure using the Azure Native provider.

 ## Overview

 This template demonstrates a simple Pulumi program written in F# that:
 - Creates an Azure Resource Group
 - Creates an Azure Storage Account (Standard_LRS, StorageV2)
 - Exports the Storage Account name

 Use this template as a foundation for building more complex Azure infrastructure in F#.
 ...
 ├── Program.fs              # F# code defining Azure resources
 ├── <ProjectName>.fsproj    # .NET project file
 ...
 - Extend `Program.fs` to add more Azure services (Virtual Networks, App Services, SQL Databases, and more)
